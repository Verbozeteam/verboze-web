...
$ npm run build
```
> **Note:** Whenever the you run the above command, delete the old bundled files, otherwise it will keep creating new files, we never use the old ones again. I will incorporate something to automate this process soon.
